...
class tagTableClass extends uu.Component {
    properties() {
      return {
          seeFlagInfoTag: {
              defaultValue: null,
    ...
    getTagList(_qparam) {
        ...
        //清除表格
        var productData=this.seeFlagInfoTag.getComponent('fixed-clown.es6')._getSeeFlag(); 
