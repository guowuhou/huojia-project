...
<form class="form-horizontal" style="margin-bottom: 40px;" role="form" id="editDiv">
  ...
  <div class="form-group" id="">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control w80 fl _check nowrite 3noEdit" value="{{quoteUnit}}" id="quoteUnit" maxlength="20">
    </div>
  </div>
  <div class="form-group" id="">
    <label for="tradingUnit" class="col-sm-2 control-label"><span class="star"></span>交易单位:</label>
    <div class="col-sm-7">
      <input type="text" class="form-control w80 fl _check nowrite 3noEdit" value="{{tradingUnit}}" id="tradingUnit" maxlength="20">
    </div>
  </div>
  <div class="form-group" id="">
    <label for="investmentStyle" class="col-sm-2 control-label"><span class="star"></span>投资方式:</label>
    <div class="col-sm-7">
      <input type="text" class="form-control w80 fl _check nowrite 3noEdit" value="{{investmentStyle}}" id="investmentStyle" maxlength="80">
    </div>
  </div>
  <div class="form-group" id="">
    <label for="agreedPeriod" class="col-sm-2 control-label"><span class="star"></span>协议期限:</label>
    <div class="col-sm-7">
      <input type="text" class="form-control w80 fl _check nowrite 3noEdit" value="{{agreedPeriod}}" id="agreedPeriod" maxlength="20">
    </div>
  </div>
  <div class="form-group" id="">
    <label for="tradingDay" class="col-sm-2 control-label"><span class="star"></span>交易日:</label>
    <div class="col-sm-7">
      <input type="text" class="form-control w80 fl _check nowrite 3noEdit" value="{{tradingDay}}" id="tradingDay" maxlength="20">
    </div>
  </div>
  <div class="form-group" id="">
    <label for="tradingHour" class="col-sm-2 control-label"><span class="star"></span>交易时间:</label>
    <div class="col-sm-7">
      <input type="text" class="form-control w80 fl _check nowrite 3noEdit" value="{{tradingHour}}" id="tradingHour" maxlength="20">
    </div>
  </div>
  <div class="form-group" id="">
    <label for="transactChannel" class="col-sm-2 control-label"><span class="star"></span>办理渠道:</label>
    <div class="col-sm-7">
      <input type="text" class="form-control w80 fl _check nowrite 3noEdit" value="{{transactChannel}}" id="transactChannel" maxlength="80">
    </div>
  </div>
  <div class="form-group" id="">
    <label for="appliedCustomer" class="col-sm-2 control-label"><span class="star"></span>适用客户:</label>
    <div class="col-sm-7">
      <textarea class="form-control w80 nowrite" rows="2" value="" id="appliedCustomer" maxLength=500>{{appliedCustomer}}</textarea>
  ...
  <div class="form-group" id="">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control w80 fl _check nowrite 3noEdit" value="{{riskWarning}}" id="riskWarning" maxlength="80">
    </div>
  </div>
  <div class="form-group" id="">
    <label for="attention" class="col-sm-2 control-label"><span class="star"></span>注意事项:</label>
    <div class="col-sm-7">
      <input type="text" class="form-control w80 fl _check nowrite 3noEdit" value="{{attention}}" id="attention" maxlength="80">
    </div>
  </div>
  <div class="form-group" id="">
    <label for="handlingProcedures" class="col-sm-2 control-label"><span class="star"></span>办理流程:</label>
    <div class="col-sm-7">
      <textarea class="form-control w80 nowrite" rows="5" value="" id="handlingProcedures" maxLength=500>{{handlingProcedures}}</textarea>
    </div>
  </div>
  <div class="form-group" id="">
    <label for="procedure" class="col-sm-2 control-label"><span class="star"></span>交易类型:</label>
    <table id="channelType" class="col-sm-6" style="margin:10px;text-align:center;height:200px;">
      <tbody>
        <tr>
          <td>交易类型</td>
          <td>手续费标准</td>
        ...
        <tr>
          <td>协议定投</td>
          <td><input type="text" style="width:100px;height:40px;" id="handlingFeeStandard1" value="{{handlingFeeStandard1}}"></td>
          <td><input type="text" style="width:400px;height:40px;" id="chargeStyle1" value="{{chargeStyle1}}"></td>
        </tr>
        <tr>
          <td>赎回</td>
          <td><input type="text" style="width:100px;height:40px;" id="handlingFeeStandard2" value="{{handlingFeeStandard2}}"></td>
          <td><input type="text" style="width:400px;height:40px;" id="chargeStyle2" value="{{chargeStyle2}}"></td>
        </tr>
      </tbody>  
    </table>
  </div>
...
<form class="form-horizontal" style="margin-bottom: 40px;" role="form" id="channels">
  <div class="form-group" id="salesChannels">
    ...
    <label class="checkbox-inline m20" uu-for="item of salesChannelsList">
          <input type="checkbox" name="salesChannelsRadio" id="customersLabelRadio3" uu-model="{{salesChannels}}" value="{{item.ddCode}}"> {{item.ddName}}
      </label>
  </div>
...
<div id='operation' style="text-align:center;">
  <button type="button" class="btn btn-info mt_20" id="edit">编辑</button>
  <button type="button" style="margin-left:15px;" class="btn .btn-info[disabled]  mt_20" id="submitBtn" disabled>提交审核</button>
</div>