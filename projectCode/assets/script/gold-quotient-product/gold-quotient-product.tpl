...
<form class="form-horizontal" style="margin-bottom: 40px;" role="form" id="basicInfo">
  ...
  <div class="form-group" id="">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control w80 fl _check nowrite 3noEdit" value="{{prdName}}" maxLength=60 id="prdName">
    </div>
  </div>
  <div class="form-group" id="">
  ...
  <div class="form-group" id="">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control w80 fl _check nowrite 3noEdit"  id="productManName" maxLength=30 value="{{productManName}}" >
    </div>
  </div>
...
<form class="form-horizontal" style="margin-bottom: 40px;" role="form" id="editDiv">
  ...
  <div class="form-group" id="">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control w80 fl _check nowrite 3noEdit" maxLength=100 value="{{investmentStyle}}" id="investmentStyle">
    </div>
  </div>
  <!--<div class="form-group" id="">
  ...
  <div class="form-group" id="">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control w80 fl _check nowrite 3noEdit" maxLength=30 value="{{tradingDay}}" id="tradingDay">
    </div>
  </div>
  <div class="form-group" id="">
    <label for="tradingHour" class="col-sm-2 control-label"><span class="star"></span>交易时间:</label>
    <div class="col-sm-7">
      <input type="text" class="form-control w80 fl _check nowrite 3noEdit" maxLength=30 value="{{tradingHour}}" id="tradingHour">
    </div>
  </div>
  <div class="form-group" id="">
    <label for="transactChannel" class="col-sm-2 control-label"><span class="star"></span>办理渠道:</label>
    <div class="col-sm-7">
      <input type="text" class="form-control w80 fl _check nowrite 3noEdit" maxLength=100 value="{{transactChannel}}" id="transactChannel">
    </div>
  </div>
  <div class="form-group" id="">
  ...
  <div class="form-group" id="">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control w80 fl _check nowrite 3noEdit" maxLength=200 value="{{riskWarning}}" id="riskWarning">
    </div>
  </div>
  <div class="form-group" id="">
