<div>
    <button type="button" class="btn btn-info fr"  id="intelligent">配置智能货架</button>
</div>
...
<form class="form-horizontal" style="margin-bottom: 40px;" role="form" id="basicInfo">
  ...
  <div class="form-group" id="">
    ...
    <div class="col-sm-7">
      <input type="text" class="form-control w80 fl _check nowrite 3noEdit" value="{{productManName}}" id="prdmanager">
    </div>
  </div>
...
<form class="form-horizontal" style="margin-bottom: 40px;" role="form" id="editDiv">
  ...
  <div class="form-group" id="">
    ...
    <div class="col-sm-7">
      <textarea class="form-control w80 nowrite" rows="2" value="" maxLength=100>{{appliedCustomer}}</textarea>
  ...
  <div class="form-group" id="">
    ...
    <div class="col-sm-7">
      <textarea class="form-control w80 nowrite" rows="3" value="" maxLength=100>{{majorFeatures}}</textarea>
    </div>
  </div>
  <div class="form-group" id="">
  ...
  <div class="form-group" id="">
    ...
    <div class="col-sm-7">
      <textarea class="form-control w80 nowrite" rows="5" value="" maxLength=100>{{handlingProcedures}}</textarea>
    </div>
  </div>
  <div class="form-group" id="">
    ...
    <table id="channelType" class="col-sm-6" style="margin:10px;text-align:center;height:200px;">
      <tbody>
        ...
        <tr>
          ...
          <td><input type="text" style="width:400px;height:40px;" value="{{chargeStyle1}}"></td>
        </tr>
        <tr>
          <td>赎回</td>
         <td><input type="text" style="width:100px;height:40px;" id="handlingFeeStandard2" value="{{handlingFeeStandard2}}"></td>
          <td><input type="text" style="width:400px;height:40px;" value="{{chargeStyle2}}"></td>
        </tr>
      </tbody>  
    </table>
  </div>
