 ...
 * ================================================ */
require('less/bootstrap-dialog.less');
...
(function (root, factory) {
    ...
    if (typeof module !== 'undefined' && module.exports) {
        module.exports = factory(require('lib/jquery.js'), require('lib/bootstrap.js'));
    }
    ...
    BootstrapDialog.DEFAULT_TEXTS['OK'] = '知道了';
    ...
    BootstrapDialog.defaultOptions = {
        ...
        message: null,
        nl2br: true,
        closable: true,     //可以通过点击弹窗外部的位置关闭弹框
        closeByBackdrop: false,  //只能通过头部的关闭按钮关闭弹框
        closeByKeyboard: false,  //只能通过头部的关闭按钮关闭弹框
        closeIcon: '&#215;',
