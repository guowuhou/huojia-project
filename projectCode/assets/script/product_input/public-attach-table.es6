...
class attachTableClass extends uu.Component {
    ...
    getAttachList(_qparam) {
        ...
        //清除表格
        var productData=this.seeFlagInfoAttach.getComponent('new-public-custom.es6')._getSeeFlag(); 
        ...
        var columnList=[
              {
                ...
                formatter:(value,row,index)=>{
                   ...
                   // var valueList=value.split(','),valueStr="";
                    // for(let i=0;i<valueList.length;i++){
                    //     valueStr+=(typeMap[valueList[i]]+',');
                    // }
