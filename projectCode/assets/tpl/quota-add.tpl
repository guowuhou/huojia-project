<form class="form-horizontal" role="form">  
    <div class="form-group">
        ...
        <div class="col-sm-7">
            <select class="form-control"  id = 'prdCode'>
            </select>
        </div>
    </div>
     <div class="form-group">
        ...
        <div class="col-sm-7">
            <select class="form-control" id = 'channelCode' >
            </select>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-7">
           <input type="text" class="form-control"  singleHoldings >          
        </div>
     ...
     <div class="form-group">
        ...
        <div class="col-sm-7">
           <input type="text" class="form-control"  channelDaySales>
     ...
     <div class="form-group">
        ...
        <div class="col-sm-7">
           <input type="text" class="form-control" channelVol >      
        </div>
        <div class = "col-sm-2">亿元</div>
    </div>
